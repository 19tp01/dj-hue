...
class LightValue:
    ...
    Attributes:
        ...
        phaser: Optional Phaser for beat-synced brightness modulation
    """
    ...
    def with_phaser(self, phaser: "Phaser") -> "LightValue":
        """Return a copy with updated phaser for brightness modulation."""
        return LightValue(
            light_id=self.light_id,
            group=self.group,
            color=self.color,
